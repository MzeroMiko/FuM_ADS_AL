...
def train_backbone(model=ADSNet().cuda(), _criterion_backbone=criterion_backbone(), unlabeled_loader=None, optimizer=None):
    ...
    for data in unlabeled_loader:
        ...
        File "main_ADS.py", line 432, in <module>
            train_ADS()
        File "main_ADS.py", line 394, in train_ADS
        ...
        File "main_ADS.py", line 251, in train_backbone
            optimizer = optim.SGD(params, lr=0.1, momentum=0.9, weight_decay=0.0005)
        File "/home/LiuYue/Workspace/opts/miniConda/lib/python3.7/site-packages/torch/optim/sgd.py", line 64, in __init__
            super(SGD, self).__init__(params, defaults)
        File "/home/LiuYue/Workspace/opts/miniConda/lib/python3.7/site-packages/torch/optim/optimizer.py", line 46, in __init__
...
def train_ADS(dataset='cifar10'):
    ...
    for trial in range(cfg.ACTIVE_LEARNING.TRIALS):
        ...
        for cycle in range(cfg.ACTIVE_LEARNING.CYCLES):
            ...
            optim_backbone = optim.SGD(model.freeze_classifier(), lr=cfg.TRAIN.LR, momentum=0, weight_decay=cfg.TRAIN.WDECAY)
            optim_classifier = optim.SGD(model.freeze_backbone(), lr=cfg.TRAIN.LR, momentum=0, weight_decay=cfg.TRAIN.WDECAY)
